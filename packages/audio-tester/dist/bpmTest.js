...
async function detectBPMWithAubio(audioBuffer, sampleRate) {
    console.log('Initializing Aubio...');
    const aubio = await Aubio();
    console.log('Creating Tempo detector...');
    const tempo = new aubio.Tempo('default', 2048, 512, sampleRate);
...
async function detectBPMWithDetective(audioBuffer, sampleRate) {
...
//# sourceMappingURL=bpmTest.js.map